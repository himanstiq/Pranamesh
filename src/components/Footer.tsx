            ...
            <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 py-10 md:grid-cols-12">
                ...
                <div className="md:col-span-3">
                    ...
                    <ul className="space-y-2 text-sm text-text-muted-light dark:text-text-muted">
                        <li>
                            <Link className="hover:text-text-dark dark:hover:text-white link-underline" href="#">
                                Contact Us
                            </Link>
                        </li>
                        <li>
                ...
                <div className="md:col-span-4">
                    ...
                    <div className="mt-4 flex items-center gap-3">
                        <a
                            href="#"
                            title="Facebook"
                            className="inline-grid h-8 w-8 place-items-center rounded-full bg-card-light dark:bg-card-dark text-sm ring-1 ring-border-light dark:ring-border-dark hover:bg-primary-light-theme hover:text-white dark:hover:bg-primary transition-spring hover:scale-110"
                        >
